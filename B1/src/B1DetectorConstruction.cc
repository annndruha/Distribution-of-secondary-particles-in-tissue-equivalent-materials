...
G4VPhysicalVolume *B1DetectorConstruction::Construct()
{
  ...
  new G4PVPlacement(0,              //no rotation
                    pos1,           //at position
                    logicWorld_box, //its logical volume
                    "Box",          //its name
  ...
  //
  G4ThreeVector pos2 = G4ThreeVector(box_len, 2 * box_len, 0);
  ...
  new G4PVPlacement(0,                //no rotation
                    pos2,             //at position
                    logicWorld_para,  //its logical volume
                    "Parallelepiped", //its name
                    logicEnv,         //its mother  volume
                    false,            //no boolean operation
                    0,                //copy number
                    checkOverlaps);   //overlaps checking
  ...
  //===============================================================================================
  // Set logicWorld_box as scoring volume
  fScoringVolume = logicWorld_box;
  return physWorld;
}